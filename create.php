...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($age > 0) {
        $sql = "INSERT INTO students (name, age, course, yrlevel) VALUES ('$name', $age, '$course', '$yrlevel')";
...
<body class="container mt-5">
    ...
    <div class="form-container mx-auto" style="max-width: 500px;">
        ...
        <form method="POST">
            ...
            <input type="text" name="yrlevel" class="form-control mb-4" placeholder="🏫 Year Level" required>
            <div class="d-flex justify-content-between">
                <button type="submit" class="btn btn-tech px-4">💾 Save</button>
                <a href="index.php" class="btn btn-back px-4">🔙 Back</a>
            </div>
        </form>
    </div>
