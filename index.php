...
<div class="container container-custom">
    <center><h2> Student System </h2>
    <a href="create.php" class="btn btn-primary mb-3">➕ Add Student</a>
    <a href="delete.php" class="btn btn-primary mb-3">🗑️ Delete</a>
    <a href="edit.php" class="btn btn-primary mb-3">✏️ Edit</a>
    ...
    <table class="table table-hover table-bordered align-middle">
        <thead class="text-center">
            <tr>
                <th>ID</th><th>Name</th><th>Age</th><th>Course</th><th>Year Level</th><th>Actions</th> 
            </tr>
        </thead>
